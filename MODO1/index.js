...
var p;
var a;
function preload(){font=loadFont("FUGA_type-Regular.otf")}
function setup() {
  ...
  h1.position(60,-40);
  h1.style('font-family', 'FUGA_type-Regular');
  h1.style('font-size', '90px');
  h1.style('color', 'white');
  h1.style('font-weight', 'bold')

  a=createA("https://juanacopello.github.io/fuga-p5/index.html","go to CLEAN_MODE")
  a.position(163,105);
  ...
  p= createP("[TYPE ANYTHING TO START]");
  p.position(60,140);
  ...
  p= createP("> Press enter to go back to (0,0)");
  p.position(60,260);
  p.style('font-family', 'arial');
  ...
  p.style('color', 'white');
  p.style('font-weight', 'bold')
  p= createP("> Click and drag to move ");
  p.position(60,280);
  p.style('font-family', 'arial');
  p.style('font-size', '14px');
  p.style('color', 'black');
  ...
  p= createP("> Use the mouse wheel to zoom in/out");
  p.position(60,300);
  p.style('font-family', 'arial');
  p.style('font-size', '14px');
  p.style('color', 'black');
...
function keyTyped() {
  ...
  if (key === 'a'|| key ==="A") {
    letraActual = LETRA_A(x, 10,0.1, "red","red");
    x = x + anchoLetra;
  } else if(key ==="b"|| key ==="B"){
    letraActual = LETRA_B(x, 10 , 0.1,"red", "red")
    x = x + anchoLetra;
  } else if(key ==="c"|| key ==="C"){
    letraActual = LETRA_C(x, 10 , 0.1,"red", "red")
    x = x + anchoLetra;
  } else if(key ==="d"|| key ==="D"){
    letraActual = LETRA_D(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  } else if(key ==="e"|| key ==="E"){
    letraActual = LETRA_E(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  } else if (key === 'f'|| key ==="F") {
    letraActual = LETRA_F(x, 10,0.1,"red","red");
    x = x + anchoLetra
  }else if (key === 'g'|| key ==="G") {
    letraActual = LETRA_G(x, 10,0.1,"red","red");
    x = x + anchoLetra
  }else if (key === 'h'|| key ==="H") {
    letraActual = LETRA_H(x, 10,0.1,"red","red");
    x = x + anchoLetra
  }else if(key ==="i"|| key ==="I"){
    letraActual = LETRA_I(x, 10,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="j"|| key ==="J"){
    letraActual = LETRA_J(x, 10,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="k"|| key ==="K"){
    letraActual = LETRA_K(x, 10,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="l"|| key ==="L"){
    letraActual = LETRA_L(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="m"|| key ==="M"){
    letraActual = LETRA_M(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="n"|| key ==="N"){
    letraActual = LETRA_N(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="ñ"|| key ==="Ñ"){
    letraActual = LETRA_N2(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="o"|| key ==="O"){
    letraActual = LETRA_O(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="p"|| key ==="P"){
    letraActual = LETRA_P(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="q"|| key ==="Q"){
    letraActual = LETRA_Q(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="r"|| key ==="R"){
    letraActual = LETRA_R(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="s"|| key ==="S"){
    letraActual = LETRA_S(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="t"|| key ==="T"){
    letraActual = LETRA_T(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="u"|| key ==="U"){
    letraActual = LETRA_U(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="v"|| key ==="V"){
    letraActual = LETRA_V(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="w"|| key ==="W"){
    letraActual = LETRA_W(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="x"|| key ==="X"){
    letraActual = LETRA_X(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="y"|| key ==="Y"){
    letraActual = LETRA_Y(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
  }else if(key ==="z"|| key ==="Z"){
    letraActual = LETRA_Z(x, 10 ,0.1,"red", "red")
    x = x + anchoLetra;
}
}
function keyPressed() {
